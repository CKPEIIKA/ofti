...
_KNIFE_HANDLER_NAMES = ["adopt", "campaign_compare", "campaign_keep", "campaign_list", "campaign_rank", "campaign_status", "campaign_stop", "changes", "captains_deck", "compare", "compare_fields", "converge", "copy", "criteria", "current", "dna", "doctor", "eta", "initials", "lint", "mesh_radar", "monitors", "physical", "preflight", "receipt_restore", "receipt_verify", "receipt_write", "report", "resource", "scopes", "set", "stability", "status", "stop"]  # noqa: E501
